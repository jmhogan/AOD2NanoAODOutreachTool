...
process.aod2nanoaod = cms.EDAnalyzer("AOD2NanoAOD", 
        ...
        jecL1Name = cms.FileInPath('workspace/AOD2NanoAODOutreachTool/data/Summer13_V4/Summer13_V4_MC_L1FastJet_AK5PF.txt'),
        jecL2Name = cms.FileInPath('workspace/AOD2NanoAODOutreachTool/data/Summer13_V4/Summer13_V4_MC_L2Relative_AK5PF.txt'),
        jecL3Name = cms.FileInPath('workspace/AOD2NanoAODOutreachTool/data/Summer13_V4/Summer13_V4_MC_L3Absolute_AK5PF.txt'),
        jecUncName = cms.FileInPath('workspace/AOD2NanoAODOutreachTool/data/Summer13_V4/Summer13_V4_MC_Uncertainty_AK5PF.txt'),
        )
